...
namespace radar_driver
{
   ...
   {
      //Topic you want to publish
      pub_ = n_.advertise<pb_msgs::ContiRadar>("/decoded_messages", 50);

      //Topic you want to subscribe
      sub_ = n_.subscribe("/received_messages", 50, &DecodeCanMessageNode::callback, this);
   }
